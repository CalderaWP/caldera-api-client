...
docker-compose run --rm -u 33 cli core install --url=localhost:$HOST_PORT --title=CalderaForming --admin_user=admin --admin_password=password --admin_email=test@test.com >/dev/null
